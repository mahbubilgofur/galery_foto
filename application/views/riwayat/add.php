                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_like" name="id_like" required>
                            <?php foreach ($like as $user) : ?>
                                <option value="<?php echo $user['id_like']; ?>"><?php echo $user['tgl_like']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_komen" name="id_komen" required>
                            <?php foreach ($komen as $user) : ?>
                                <option value="<?php echo $user['id_komen']; ?>"><?php echo $user['isi_komentar']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
